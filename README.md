...
| `API_KEY`                | `"REDACTED_OLD_API_KEY"`       | Cle d'authentification. |
...
- **OTA** : Mise a jour sans fil (mot de passe : `REDACTED_OTA_PASSWORD`).
...
|:-----------------|:------|:-------------------------------|:---------------------|
| `WIFI_SSID`      | 32    | `"REDACTED_WIFI_SSID_A"`                   | Le nom du reseau WiFi. |
| `WIFI_PASSWORD`  | 33    | `"REDACTED_WIFI_PASSWORD_A"`           | Le mot de passe WiFi. |
...
2. Entrer le mot de passe OTA : `REDACTED_OTA_PASSWORD`.
